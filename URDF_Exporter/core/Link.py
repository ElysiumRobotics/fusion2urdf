...
class Link:
    ...
    def make_link_xml(self):
        ...
        mass.attrib = {'value':"{:.12f}".format(self.mass)}
        inertia = SubElement(inertial, 'inertia')
        inertia.attrib = \
            {'ixx':"{:.12f}".format(self.inertia_tensor[0]), 'iyy':"{:.12f}".format(self.inertia_tensor[1]),\
            'izz':"{:.12f}".format(self.inertia_tensor[2]), 'ixy':"{:.12f}".format(self.inertia_tensor[3]),\
            'iyz':"{:.12f}".format(self.inertia_tensor[4]), 'ixz':"{:.12f}".format(self.inertia_tensor[5])}        
